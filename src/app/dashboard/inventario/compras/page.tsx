...
import { registerPurchaseAction } from '@/app/actions/inventory.actions';
...
export default function ComprasPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await registerPurchaseAction({
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">
                            Ingreso de mercancía de proveedores
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        const item = mockRawMaterials.find(i => i.id === e.target.value);
                                        if (item) {
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    >
                                        <option value="UNIT">Sacos/Unidades</option>
                                        <option value="KG">Kilogramos</option>
                                        <option value="L">Litros</option>
                                        <option value="G">Gramos</option>
                                    </select>
                                </div>
                                {selectedItemData && unit === 'UNIT' && selectedItem === 'ins-leche' && (
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Ej: Proveedor: Lácteos del Valle, Factura #1234"
                                    rows={2}
